            ...
            <div class="row  align-items-center">
                ...
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="banner-img-block">
                        <img src="{{ asset('site5assets/images/banner-img-5.png') }}" alt="banner-img" class="img-fluid">
                    </div>
                </div>
            </div> <!-- / .row -->
        </div> <!-- / .container -->
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-6 mb-5">
                    <div class="single-project">
                        <img src="{{ asset('site5assets/images/projects/p-1.jpg') }}" alt="" class="img-fluid">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-5">
                    <div class="single-project">
                        <img src="{{ asset('site5assets/images/projects/p-4.jpg') }}" alt="" class="img-fluid">
                        <div class="project-content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-8 ">
                    <div class="single-project">
                        <img src="{{ asset('site5assets/images/projects/p-3.jpg') }}" alt="" class="img-fluid">
                        <div class="project-content">
            ...
            <div class="row py-4">
                <div class="col-lg-7 col-md-12 col-sm-12 ">
                    <div class="single-project">
                        <img src="{{ asset('site5assets/images/bg/banner_bg.jpg') }}" alt="" class="img-fluid">
                    </div>
                </div>
