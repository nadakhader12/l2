  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-3 col-sm-6 mb-5">
        <div class="ts-team-wrapper">
          <div class="team-img-wrapper">
            <img loading="lazy" src="{{ asset('site3assets/images/team/team1.jpg') }}" class="img-fluid" alt="team-img">
          </div>
      ...
      <div class="col-lg-3 col-sm-6 mb-5">
        <div class="ts-team-wrapper">
          <div class="team-img-wrapper">
            <img loading="lazy" src="{{ asset('site3assets/images/team/team2.jpg') }}" class="img-fluid" alt="team-img">
          </div>
          <div class="ts-team-content-classic">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-4 col-sm-6 mb-5">
        <div class="ts-team-wrapper">
          <div class="team-img-wrapper">
            <img loading="lazy" src="{{ asset('site3assets/images/team/team3.jpg') }}" class="img-fluid" alt="team-img">
          </div>
          <div class="ts-team-content-classic">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 mb-5">
        <div class="ts-team-wrapper">
          <div class="team-img-wrapper">
            <img loading="lazy" src="{{ asset('site3assets/images/team/team4.jpg') }}" class="img-fluid" alt="team-img">
          </div>
          <div class="ts-team-content-classic">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 mb-5">
        <div class="ts-team-wrapper">
          <div class="team-img-wrapper">
            <img loading="lazy" src="{{ asset('site3assets/images/team/team5.jpg') }}" class="img-fluid" alt="team-img">
          </div>
          <div class="ts-team-content-classic">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 mb-5">
        <div class="ts-team-wrapper">
          <div class="team-img-wrapper">
            <img loading="lazy" src="{{ asset('site3assets/images/team/team6.jpg') }}" class="img-fluid" alt="team-img">
          </div>
          <div class="ts-team-content-classic">
