...
<div id="banner-area" class="banner-area" style="background-image:url({{ asset('site3assets/images/banner/banner1.jpg') }})">
  <div class="banner-text">{{ asset('site3assets/  <div class="banner-text">') }}
    <div class="container">
        <div class="row">
          <div class="col-lg-12">
      ...
      <div class="col-lg-8 mb-5 mb-lg-0">
        ...
        <div class="post-content post-single">
          <div class="post-media post-image">
            <img loading="lazy" src="{{ asset('site3assets/images/news/news1.jpg') }}" class="img-fluid" alt="post-image">
          </div>
{{ asset('site3assets/') }}
          <div class="post-body">
        ...
        <div class="author-box d-nlock d-sm-flex">
          <div class="author-img mb-4 mb-md-0">
            <img loading="lazy" src="{{ asset('site3assets/images/news/avator1.png') }}" alt="author">
          </div>
          ...
          <ul class="comments-list">
            <li>
              <div class="comment d-flex">
                <img loading="lazy" class="comment-avatar" alt="author" src="{{ asset('site3assets/images/news/avator1.png') }}">
              ...
              <ul class="comments-reply">
                <li>
                  <div class="comment d-flex">
                    <img loading="lazy" class="comment-avatar" alt="author" src="{{ asset('site3assets/images/news/avator2.png') }}">
                    <div class="comment-body">
                      <div class="meta-data">
              ...
              <div class="comment d-flex last">
                <img loading="lazy" class="comment-avatar" alt="author" src="{{ asset('site3assets/images/news/avator3.png') }}">
                <div class="comment-body">
                  <div class="meta-data">
            ...
            <ul class="list-unstyled">
              <li class="d-flex align-items-center">
                <div class="posts-thumb">
                  <a href="#"><img loading="lazy" alt="img" src="{{ asset('site3assets/images/news/news1.jpg') }}"></a>
                </div>
                <div class="post-info">
              ...
              <li class="d-flex align-items-center">
                <div class="posts-thumb">
                  <a href="#"><img loading="lazy" alt="img" src="{{ asset('site3assets/images/news/news2.jpg') }}"></a>
                </div>
                <div class="post-info">
                  <h4 class="entry-title">
              ...
              <li class="d-flex align-items-center">
                <div class="posts-thumb">
                  <a href="#"><img loading="lazy" alt="img" src="{{ asset('site3assets/images/news/news3.jpg') }}"></a>
                </div>
                <div class="post-info">
                  <h4 class="entry-title">
