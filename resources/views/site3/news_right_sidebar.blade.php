  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-8 mb-5 mb-lg-0">
        ...
        <div class="post">
          <div class="post-media post-video">
            <div class="embed-responsive embed-responsive-16by9">
              <!-- Change the url -->
              <iframe class="embed-responsive-item" src="{{ asset('site3assets///player.vimeo.com/video/153089270?title=0&ampbyline=0&amp;portrait=0&amp;color=8aba56') }} allowfullscreen"></iframe>
            </div>
          </div>
        ...
        <div class="post">
          <div class="post-media post-image">
            <img loading="lazy" src="{{ asset('site3assets/images/news/news3.jpg') }}" class="img-fluid" alt="post-image">
          </div>
