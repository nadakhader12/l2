    ...
    <div class="row">
        ...
        <div class="col-lg-6 mt-5 mt-lg-0">
          ...
          <div id="page-slider" class="page-slider small-bg">
              ...
              <div class="item" style="background-image:url({{ asset('site3assets/images/slider-pages/slide-page1.jpg') }})">
                <div class="container">
              ...
              <div class="item" style="background-image:url({{ asset('site3assets/images/slider-pages/slide-page2.jpg') }})">
                <div class="container">
                    <div class="box-slider-content">
                      <div class="box-slider-text">
              ...
              <div class="item" style="background-image:url({{ asset('site3assets/images/slider-pages/slide-page3.jpg') }})">
                <div class="container">
                    <div class="box-slider-content">
                      <div class="box-slider-text">
        ...
        <div class="col-lg-12">
          <div id="team-slide" class="team-slide">
              <div class="item">
                <div class="ts-team-wrapper">
                    <div class="team-img-wrapper">
                      <img loading="lazy" class="w-100" src="{{ asset('site3assets/images/team/team1.jpg') }}" alt="team-img">
                    </div>
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    <div class="team-img-wrapper">
                      <img loading="lazy" class="w-100" src="{{ asset('site3assets/images/team/team2.jpg') }}" alt="team-img">
                    </div>
                    <div class="ts-team-content">
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    <div class="team-img-wrapper">
                      <img loading="lazy" class="w-100" src="{{ asset('site3assets/images/team/team3.jpg') }}" alt="team-img">
                    </div>
                    <div class="ts-team-content">
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    <div class="team-img-wrapper">
                      <img loading="lazy" class="w-100" src="{{ asset('site3assets/images/team/team4.jpg') }}" alt="team-img">
                    </div>
                    <div class="ts-team-content">
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    <div class="team-img-wrapper">
                      <img loading="lazy" class="w-100" src="{{ asset('site3assets/images/team/team5.jpg') }}" alt="team-img">
                    </div>
                    <div class="ts-team-content">
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    <div class="team-img-wrapper">
                      <img loading="lazy" class="w-100" src="{{ asset('site3assets/images/team/team6.jpg') }}" alt="team-img">
                    </div>
                    <div class="ts-team-content">
