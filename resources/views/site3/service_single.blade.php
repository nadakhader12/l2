      ...
      <div class="col-xl-8 col-lg-8">
        <div class="content-inner-page">
          ...
          <div id="page-slider" class="page-slider">
            <div class="item">
              <img loading="lazy" class="img-fluid" src="{{ asset('site3assets/images/projects/project1.jpg') }}" alt="project-slider-image" />
            </div>

            <div class="item">
              <img loading="lazy" class="img-fluid" src="{{ asset('site3assets/images/projects/project2.jpg') }}" alt="project-slider-image" />
            </div>
          </div><!-- Page slider end -->
